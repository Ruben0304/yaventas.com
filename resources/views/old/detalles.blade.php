            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">${{$producto->preciocup}}</div>
                        <p>{{$producto['descripcion']}}</p>
                        <div style="display: none">     {{$micro=date('u')}}</div> 
                        @auth
                        <form action="{{route('agregar_carrito')}}" method="POST" name="addcart{{Auth::user()->id*$micro*$producto->id}}">
                            @csrf
                        ...
                        <a href="javascript:document.addcart{{Auth::user()->id*$micro*$producto->id}}.submit()" class="primary-btn">Agregar al carrito</a>
                        <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
                    </form>
                        <ul>
                            @if ($producto['stock']>0 )
                            <li><b>Disponibilidad</b> <span>{{$producto->stock}} en Stock</span></li>    
                            @else
                            <li><b>Disponibilidad</b> <span>Agotado</span></li>
                           
                            
                            @endif
                           
                            <li><b>Envio</b> <span>1 dia de envio. <samp>Recojida gratis.</samp></span></li>
