                    ...
                    <td>
                      <div class="avatar-group mt-2">
                       ...
                       @endphp
                        ...
                        <a href="{{route('detalles','id='.$detalle->producto->id.'')}}" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$detalle->producto->nombre}}">
