...
Route::controller(AdminController::class)->group(function (){
    ...
    Route::get('/admin', 'dashboard')->middleware(['auth', 'verified'])->name('admin');
    ...
    Route::put('/admin/actualizar_categoria', 'actualizar_categoria')->middleware(['auth', 'verified'])->name('actualizar_categoria');
